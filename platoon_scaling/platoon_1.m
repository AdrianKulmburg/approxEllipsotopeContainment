function f = platoon_1(x,u,w)
% PLATOON_1 - dynamic equations for the car benchmark model, with 1 vehicle
%
% Syntax:
%       f = PLATOON_1(x,u,w)
%
% Description:
%
%       The benchmarks represents a platoon with 1 vehicle, where the
