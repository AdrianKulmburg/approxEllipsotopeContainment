function f = platoon_10(x,u,w)
% PLATOON_10 - dynamic equations for the car benchmark model, with 10
%    vehicles
%
% Syntax:
%       f = PLATOON_10(x,u,w)
...
% Description:
%
%       The benchmarks represents a platoon with 10 vehicles, where the
